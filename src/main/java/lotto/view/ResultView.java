...
public class ResultView {
    ...
    public static void printResult(WinningResult winningResult, String totalReturnRate) {
        ...
        System.out.printf("4개 일치 (50000원)- %d개%n", winningResult.getMatchCount(Match.THIRD));
        System.out.printf("5개 일치 (1500000원)- %d개%n", winningResult.getMatchCount(Match.SECOND));
