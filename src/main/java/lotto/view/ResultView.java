...
public class ResultView {
    ...
    public static void printResult(WinningResult winningResult, String totalReturnRate) {
        ...
        System.out.println("---------");
        System.out.printf("3개 일치 (5000원)- %d개%n", winningResult.getThreeMatch());
        System.out.printf("4개 일치 (50000원)- %d개%n", winningResult.getFourMatch());
        System.out.printf("5개 일치 (1500000원)- %d개%n", winningResult.getFiveMatch());
        System.out.printf("6개 일치 (2000000000원)- %d개%n", winningResult.getSixMatch());
