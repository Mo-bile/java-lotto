...
class WinningResultTest {
    ...
    void 일치하는_정보가_있으면_해당하는_일치갯수1을_증가시킨다() {
        ...
        winningResult.increaseMatch(Match.fromLottoNumber(5));
        assertThat(winningResult).isEqualTo(new WinningResult(0, 0, 1, 0));
    }
